<template>
     <el-input class="search-box" v-model="inputInfo" placeholder=" 请输入检索信息">
        <template #prefix>
...
import {getRowSpanMethod} from '../utils/use-span-method'
  ...
  const projectInfo = [
    ...
    {
      project_Id: 'NEWUBK-20221310-022',
      project_Name: 'Tom',
      customer: 'No. 189, Grove St, Los Angeles',
      is_Installed:'是',
      is_Exported:'否',
    ...
    {
      project_Id: 'NEWUBK-2020-022',
      project_Name: 'gehsehn',
      customer: 'No. 189, Grove St, Los Angeles',
      is_Installed:'是',
      is_Exported:'否',
      design_Location:'天sdbhshsejh津',
      process_Location:'天津',
      company_Installation:'北京',
      staff_Market:'jack',
      staff_Machinery:'jack',
